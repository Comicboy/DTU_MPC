'''
Script for evaluating Kalman Filters in the model with deterministic disturbances
'''
...
x, y, z, T_all, X_all, H_all = sim22(ts, xs, u, ds, p, d_noise_level=0, v_noise_level=0, plot=False)
